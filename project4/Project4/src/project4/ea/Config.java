...
import project4.ann.actfunc.ActivationFunction;
...
public abstract class Config<G extends Gtype, P extends Ptype> {
	...
	public static final int SCENARIO_STANDARD						= 16;
	public static final int SCENARIO_PULL     						= 17;
	public static final int SCENARIO_NOWRAP  						= 18;
	...
	public int[]			    annConfig				= { 5, 2, 2 };
	public int                  annNumGains             = NeuralNetwork.getNumGainsForConfig(annConfig);
	public int                  annNumTaus              = NeuralNetwork.getNumTausForConfig(annConfig);
	public int                  annNumWeights           = NeuralNetwork.getNumWeightsForConfig(annConfig);
	public int                  annNumBiases            = NeuralNetwork.getNumBiasesForConfig(annConfig);
	public int                  annNumComponents        = annNumGains + annNumTaus + annNumWeights;
	public ActivationFunction[] actFunc					= { ActivationFunction.getInstance("sigmoid") };
	public int                  scenario                = SCENARIO_STANDARD;
